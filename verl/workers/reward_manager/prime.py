...
async def parallel_compute_score_async(
    ...
    with ProcessPoolExecutor(max_workers=num_processes) as executor:
        ...
        try:
            ...
            tasks_async = [
                single_compute_score(evaluation_func, c, r, t, ei, executor, timeout=600.0)
            ...
            pids = list(executor._processes.keys()) if executor._processes else []
            terminated_count = 0
            if pids:
                all_procs = []
                for pid in pids:
...
class PrimeRewardManager(AbstractRewardManager):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.num_processes = kwargs.get("num_processes", 128)
