...
def reliability_guard(maximum_memory_bytes=None):
    ...
    os.getcwd = None
    os.chdir = None
    os.popen = None        # Can run shell commands
    os.execl = None        # Replace current process with new program
    os.execle = None
    os.execlp = None
    os.execlpe = None
    os.execv = None
    ...
    os.execvp = None
    os.execvpe = None
    os.spawnl = None       # Spawn new process
    os.spawnle = None
    os.spawnlp = None
    os.spawnlpe = None
    os.spawnv = None
    ...
    os.spawnvp = None
    os.spawnvpe = None
    os.posix_spawn = None  # POSIX spawn
    os.posix_spawnp = None
