...
def _temp_run(sample, generation, debug, result, metadata_list, timeout):
    # Create a temporary directory and cd into it to isolate any files created by generated code
    temp_dir = tempfile.mkdtemp()
    original_dir = os.getcwd()
    # Save references to os functions before they get nullified by reliability_guard()
    _chdir = os.chdir
